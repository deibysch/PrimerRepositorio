...
export default function Agregarlinea() {
   ...
   return (
      <div id='divAgregarLinea'>
         <div id='divPantalla'>
         {useMemo(()=> <div id='divDibujar' style={{display: 'none'}}>
               <h2>RUTA {page}</h2>
               <h5>Selecciona el Inicio y Fin de la Ruta</h5>
               <MapRouteMaker ref={mapRoute1} /*style={{display: (page == 1? 'flex': 'none')}}*//>
               <MapRouteMaker ref={mapRoute2} /*style={{display: (page == 2? 'flex': 'none')}}*//>
            </div>,[])}
